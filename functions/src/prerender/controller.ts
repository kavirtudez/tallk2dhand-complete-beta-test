...
<OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/">
  ...
  <Description>Translate on ai-converse</Description>
  <Image height="16" type="image/icon" width="16">https://ai.converse/assets/icons/favicon.ico</Image>
  <Url type="text/html" method="get" template="https://ai.converse/?text={searchTerms}&amp;utm_source=opensearch"/>
